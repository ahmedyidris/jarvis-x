...
chk "every action gated"          "grep -q 'AUTO = new Set(\[\])' code/agent.js"
chk "exec.js routes via guard"    "grep -q 'guard(' code/exec.js"
...
chk "correctness tracked"         "grep -q 'RIGHT action' code/agent.js"
...
m "human gate on all"      "grep -q 'AUTO = new Set(\[\])' code/agent.js"
...
m "paper trading engine"   "[ -f code/paper.js ]"
