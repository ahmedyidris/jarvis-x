...
| Accent color | **Unresolved** — `--accent` in BrandGuidelines.md is a placeholder cyan pending Ahmed's actual pick |
...
- **Accent color** is unconfirmed — cyan is a working placeholder in `BrandGuidelines.md`. Get Ahmed's actual pick (or hex) before locking component styles.
